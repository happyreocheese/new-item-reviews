...
const Header = () => {
	...
	return (
		<>
			<header className="flex flex-col md:flex-row mx-auto h-48 px-10 py-4 md:h-28">
				<div className="flex text-4xl text-gray-700 sm:text-6xl">
					<img src="./img/database.png" alt="a" className="w-20 h-20 object-cover mr-8" />
